...
) : IShippingService
{
    ...
    public virtual async Task<Result<AvailableServicesResponse>> GetAvailableServicesAsync(int toDistrictId, CancellationToken cancellationToken)
    {
        return await _wrappee.GetAvailableServicesAsync(toDistrictId, cancellationToken);
    }
}
