...
public static class CustomerErrors
{
    ...
    public static readonly Error UpdateFailed = Error.Failure("Customer.UpdateFailed", "Customer update failed.");
    public static readonly Error BlockFailed = Error.Failure("Customer.BlockFailed", "Customer blocking failed.");
